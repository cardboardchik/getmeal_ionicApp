    ...
    connectedCallback() {
      this.innerHTML = `
        ...
        <div class="next-div-container">
            <ion-router-link href="/page-cart">
      ...
      `;
    // document.body.appendChild(document.createElement('script')).src = 'static/script.js';
    }
  }
...
customElements.define('page-menu', PageOne);
customElements.define('page-cart', PageTwo);
